...
var Accordion = /*#__PURE__*/function () {
  ...
  _createClass(Accordion, [{
    key: "openDefaultTab",
    value: function openDefaultTab(numberTab) {
    ...
    key: "resetTabs",
    value: function resetTabs(openedTabNumber) {
      for (var tab = 0; tab < this.elButtonsAccordion.length; tab++) {
    ...
    key: "tabClickHandler",
    value: function tabClickHandler(elContent, elButton, openedTabNumber) {
      var _this = this;

      elButton.addEventListener('click', function () {
        _this.resetTabs(openedTabNumber);
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function modalClickHandler(evt) {
      var target = evt.target;
      var elModal = document.querySelector("[data-modal='".concat(this.modalName, "']"));
      var elModalCloseButton = elModal.querySelector('[data-close-modal]');

      if (evt.target !== elModalCloseButton || evt.target !== elModal) {
        return;
      }
