...
var Accordion = /*#__PURE__*/function () {
  function Accordion(elAccordion, maxViewportSize) {
    var defaultOpenedTab = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  ...
  _createClass(Accordion, [{
    key: "_openDefaultTab",
    value: function _openDefaultTab(numberTab) {
    ...
    key: "_resetTabs",
    value: function _resetTabs(openedTabNumber) {
      for (var tab = 0; tab < this._elButtonsAccordion.length; tab++) {
    ...
    value: function _tabClickHandler(elContent, elButton, openedTabNumber) {
      var _this = this;

      elButton.addEventListener("click", function () {
        _this._resetTabs(openedTabNumber);
...
var initAccordions = function initAccordions() {
  ...
  var MAX_VIEWPORT_SIZE = 770;
  var DEFAULT_OPEN_TAB = undefined;

  for (var i = 0; i < elAccordions.length; i++) {
    var accordion = new _accordion__WEBPACK_IMPORTED_MODULE_0__["Accordion"](elAccordions[i], MAX_VIEWPORT_SIZE, DEFAULT_OPEN_TAB);
    accordion.init();
  }
};
...
var Expander = /*#__PURE__*/function () {
  ...
  _createClass(Expander, [{
    ...
    value: function _buttonClickHandler() {
      ...
      this._elButton.addEventListener("click", function () {
        _this._toggleContent();
      });
    }
  }, {
    key: "init",
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function _modalClickHandler(evt) {
      var target = evt.target;
      var modal = document.querySelector("[data-modal='".concat(this._modalName, "']"));
...
var PhoneMask = /*#__PURE__*/function () {
  ...
  _createClass(PhoneMask, [{
    key: "_preventDelStart",
    value: function _preventDelStart() {
      if (this._position <= this._startPosition || this._elInput.value.substring(0, this._startPosition) !== this._start) {
        this._elInput.value = this._start;
      }
    }
  }, {
    key: "_preventSymbolAxceptNumber",
    value: function _preventSymbolAxceptNumber(evt) {
    ...
    key: "_limitByMask",
    value: function _limitByMask(evt) {
    ...
    key: "_addListeners",
    value: function _addListeners(evt) {
      evt.preventDefault();
